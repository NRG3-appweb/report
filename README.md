...
- [Project Report Collaboration Insights](#project-report-collaboration-insights)
  - [Repartición de tareas:](#repartición-de-tareas)
  - [TB1](#tb1)
...
- [User Flows a Validar](#user-flows-a-validar)
  - [Para el Segmento Cliente](#para-el-segmento-cliente)
  - [Para el Segmento Empresa](#para-el-segmento-empresa)
- [Formato de Registro de la Entrevista](#formato-de-registro-de-la-entrevista)
  - [Preguntas para el Segmento Cliente](#preguntas-para-el-segmento-cliente)
    - [Catálogo de Servicios](#catálogo-de-servicios)
    - [Creación de Reserva de Cita](#creación-de-reserva-de-cita)
    - [Visualización de Historial](#visualización-de-historial)
    - [Reviews](#reviews)
  - [Preguntas para el Segmento Empresa](#preguntas-para-el-segmento-empresa)
    - [Visualización de Servicios](#visualización-de-servicios)
    - [Creación de Servicio](#creación-de-servicio-1)
    - [Gestión de Servicios y Reservas](#gestión-de-servicios-y-reservas)
    ...
    - [Tareas a Evaluar](#tareas-a-evaluar)
      - [Para el Segmento Cliente:](#para-el-segmento-cliente-1)
      - [Para el Segmento Empresa:](#para-el-segmento-empresa-1)
    - [Escala de Severidad](#escala-de-severidad)
    - [Tabla Resumen](#tabla-resumen)
    - [Descripción de Problemas](#descripción-de-problemas)
      - [Problema #1: Navegación lenta y con muchos pasos entre secciones](#problema-1-navegación-lenta-y-con-muchos-pasos-entre-secciones)
      - [Problema #2: Falta de opciones de personalización en la creación de servicios](#problema-2-falta-de-opciones-de-personalización-en-la-creación-de-servicios)
      - [Problema #3: Filtros ocupan demasiado espacio en la pantalla de búsqueda](#problema-3-filtros-ocupan-demasiado-espacio-en-la-pantalla-de-búsqueda)
      - [Problema #4: Diálogos grandes con demasiada información no priorizada](#problema-4-diálogos-grandes-con-demasiada-información-no-priorizada)
      - [Problema #5: Confusión en el mensaje "ver más" al seleccionar un review](#problema-5-confusión-en-el-mensaje-ver-más-al-seleccionar-un-review)
      - [Problema #6: Falta de confirmaciones en acciones dentro del historial de reseñas](#problema-6-falta-de-confirmaciones-en-acciones-dentro-del-historial-de-reseñas)
      - [Problema #7: No se puede responder a reseñas desde el perfil del servicio](#problema-7-no-se-puede-responder-a-reseñas-desde-el-perfil-del-servicio)
    - [User Flows a Validar](#user-flows-a-validar-1)
      - [Para el Segmento Cliente:](#para-el-segmento-cliente-2)
      - [Para el Segmento Empresa:](#para-el-segmento-empresa-2)
