# upc-pre-202402-si730-WS53-NRG3-report
...
- [upc-pre-202402-si730-WS53-NRG3-report](#upc-pre-202402-si730-ws53-nrg3-report)
...
<table border="1" style="text-align: left;">
	<tbody>
        ...
        <tr>
            ...
            <td colspan="1">Gestión Reservas</td>
            <td colspan="1">
            <strong>Como</strong> usuario de la aplicación (cliente o empresa), <strong>quiero</strong> visualizar mis reservas <strong>para</strong> asegurarme de manejar correctamente mi tiempo y no perderme la cita agendada.
            </td>
		</tr>
        <tr>
            <td colspan="1">EP012</td>
            <td colspan="1">Acceso a información relevante</td>
            <td colspan="1">
            <strong>Como</strong> visitante del sitio web <strong>quiero</strong> conocer la información más relevantes de Bliss <strong>para</strong> tener seguridad en el servicio.
            </td>
		</tr>
	</tbody>
</table>
