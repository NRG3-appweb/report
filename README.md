...
<table>
  ...
  <tr>
    ...
    <td>
      Juan Astonitas<br>TB1:<br> Tome la mayor parte de la responsabilidad del desarrollo del primer y segundo capitulo. <br> TP1: <br> Apoye a mis compañeros para la correcta creacion y documentacion de los api services <br> TB2:<br> Deiseñe y designe las tareas para el desorrollo de los enpoints del bounded context de appointment management. <br> 
